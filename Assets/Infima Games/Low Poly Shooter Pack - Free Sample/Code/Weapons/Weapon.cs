...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        protected override void Awake()
        {
            ...
            // Some weapon prefabs can exist outside the player-controlled setup.
            ...
            Camera worldCamera = characterBehaviour.GetCameraWorld();
            if (worldCamera != null)
                playerCamera = worldCamera.transform;
        }
        protected override void Start()
        {
            ...
            //Max Out Ammo.
            ammunitionCurrent = magazineBehaviour != null ? magazineBehaviour.GetAmmunitionTotal() : 0;
        }
        ...
        {
            if (animator == null || magazineBehaviour == null)
                return;
        ...
        {
            if (playerCamera == null && ServiceLocator.Current != null)
            {
                gameModeService = ServiceLocator.Current.Get<IGameModeService>();
                if (gameModeService != null)
                {
            ...
            if (muzzleSocket == null || animator == null || magazineBehaviour == null || prefabProjectile == null)
                return;
